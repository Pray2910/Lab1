...
-- 1. Load cleaned_data
data = LOAD '/user/thinhphien/cleaned_data' USING PigStorage(';') 
...
-- 7. Store kết quả
STORE max_neg INTO '/user/thinhphien/output/bai3_most_negative_aspect' USING PigStorage(',');
STORE max_pos INTO '/user/thinhphien/output/bai3_most_positive_aspect' USING PigStorage(',');